...
export const withLazyLoading = <P extends object>(
  ...
  const WrappedComponent = (props: P & { lazyProps?: Omit<LazyComponentProps, 'children'> }) => {
  ...
  WrappedComponent.displayName = `LazyComponent(${Component.displayName || Component.name || 'Component'})`;
