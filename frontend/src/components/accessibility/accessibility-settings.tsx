...
export function AccessibilitySettings() {
  ...
  return (
    <Card className="p-6">
      ...
      {/* High Contrast Mode */}
      <div className="mb-6">
        <h3 className="text-lg font-medium mb-3">High Contrast Mode</h3>
      ...
      <div className="mb-6">
        ...
        <div className="text-sm text-gray-600 space-y-2">
          <p><kbd className="px-2 py-1 bg-gray-100 rounded">Tab</kbd> - Navigate forward</p>
          <p><kbd className="px-2 py-1 bg-gray-100 rounded">Shift + Tab</kbd> - Navigate backward</p>
          <p><kbd className="px-2 py-1 bg-gray-100 rounded">Enter</kbd> - Activate buttons and links</p>
          <p><kbd className="px-2 py-1 bg-gray-100 rounded">Escape</kbd> - Close modals and menus</p>
          <p><kbd className="px-2 py-1 bg-gray-100 rounded">Arrow Keys</kbd> - Navigate within components</p>
        </div>
      </div>
