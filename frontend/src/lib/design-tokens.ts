/**
 * Design Tokens - Shared design system foundation
 * Contains colors, typography, spacing, and animation configurations
 */

// Color System
export const colors = {
  // Primary gradient system (Blue to Purple spectrum)
  primary: {
    50: '#f0f9ff',
    100: '#e0f2fe',
    200: '#bae6fd',
...
export const animations = {
  ...
  duration: {
    ...
    slow: 700,     // Slow, dramatic effects
  },
...
export type ResponsiveBreakpoints = typeof breakpoints;
