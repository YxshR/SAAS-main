...
export const AnimatedWrapper = ({
  ...
  const variants = animationUtils.createVariants(animationVariants[animation])(prefersReducedMotion)
...
export const HoverWrapper = ({
  ...
  const hoverAnimation = prefersReducedMotion ? {} : {
    ...
    y: hoverY,
    rotate: hoverRotate,
    transition: { duration: 0.15, ease: [0, 0, 0.2, 1] as any }
  }
...
export const StaggerItem = ({
  ...
  const itemVariants = prefersReducedMotion ? {
    ...
    visible: {
      y: 0,
      opacity: 1,
      transition: { duration: 0.3, ease: [0, 0, 0.2, 1] as any }
    }
  }
