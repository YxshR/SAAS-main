...
import { a11yTest } from '../../lib/accessibility/index'
        ...
        >
          <div className="bg-white rounded-lg p-6 max-w-2xl w-full mx-4 max-h-96 overflow-y-auto">
            <div className="flex justify-between items-center mb-4">
              <h2 id="a11y-tester-title" className="text-xl font-semibold">
            ...
            <div className="mb-4">
              <button
                ...
                disabled={isRunning}
                className="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-blue-500"
              >
