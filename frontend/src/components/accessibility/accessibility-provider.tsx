...
function showKeyboardShortcuts() {
  ...
  shortcuts.forEach(shortcut => {
    ...
    keyElement.className = 'px-2 py-1 bg-gray-100 rounded text-sm font-mono'
    
    const description = document.createElement('span')
    description.textContent = shortcut.description
    description.className = 'text-sm text-gray-600 ml-4 flex-1'
  ...
  closeButton.className = 'w-full bg-blue-600 text-white py-2 px-4 rounded hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500'
